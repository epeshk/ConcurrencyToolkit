...
public partial class StripedDictionary<TKey, TValue, TComparer>
{
  public readonly struct AlternateLookup<TAlternateKey> where TAlternateKey : allows ref struct
  {
    ...
    public bool TryAdd(TAlternateKey key, TValue value) =>
      that.Insert<RefuseModifyPolicy, TAlternateKey, AlternateEquality>(key, value);
    ...
    public TValue this[TAlternateKey key]
    {
      ...
      get => that.TryGetValue<TAlternateKey, AlternateEquality>(key, out var value)
        ? value
        : ThrowHelper.KeyNotFound<TKey, TValue>(that.comparer.CreateKey<TAlternateKey, AlternateEquality>(key));
    ...
    public TValue GetOrAdd<TArg>(TAlternateKey key, Func<TAlternateKey, TArg, TValue> valueFactory,
    ...
    public TValue AddOrUpdate<TArg>(
      ...
      TArg factoryArgument)
      => that.AddOrUpdate<TAlternateKey, AlternateEquality, TArg>(key, addValueFactory, updateValueFactory,
        factoryArgument);
    ...
    public TValue AddOrUpdate(TAlternateKey key, TValue addValue,
      Func<TAlternateKey, TValue, TValue> updateValueFactory)
